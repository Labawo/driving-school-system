...
if ($_SESSION['prev'] != "procregisterA")  inisession("part");  // pradinis bandymas registruoti

$_SESSION['prev']="registerA";
?>
    <html>
        <head>  
            <meta http-equiv="X-UA-Compatible" content="IE=9; text/html; charset=utf-8"> 
            <title>Registruotis kaip administratorius</title>
                    ...
                    <table class="center"><tr><td><img src="include/top.png" width="500" height="200"></td></tr><tr><td> 
                        <table style="border-width: 2px; border-style: dotted;"><tr><td>
                           Atgal į <a href="index.php">Pradžia</a></td></tr>
								...
								<div align="center">
                    			<table> <tr><td>
                                    <form action="procregisterA.php" method="POST" class="login">              
                                                <center style="font-size:18pt;"><b>Registruotis kaip administratorius</b></center>
