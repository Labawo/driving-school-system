  ...
  $_SESSION['prev'] = "procregister";
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------
		 ...
		 if (mysqli_query($db, $sql)) 
		      {
            $sql = "INSERT INTO " . TBL_LECT. " (vardas, pavarde, telefonas, asmens_kodas, kursu_sk, id)
          VALUES ('$vardas', '$pavarde', '$tel_nr','$ak', 0 , '$userid')";
