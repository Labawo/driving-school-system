...
<html>
    ...
    <body>
		...
		<center><font size="5">Vartotojų peržiūra ir įgaliojimų keitimas</font></center></td></tr></table> <br>
	    ...
	    <table class="center" style=" width:75%; border-width: 2px; border-style: dotted;">
		         <tr><td width=30%><a href="index.php">Atgal</a></td>
				 <!-- <td width=30%> 
	<?php
...
<?php
	...
	$sql = "SELECT slapyvardis,lygmuo,el_pastas,timestamp "
            . "FROM " . TBL_USERS . " ORDER BY lygmuo DESC,slapyvardis";
