...
if ($_SESSION['prev'] != "procregisterS")  inisession("part");  // pradinis bandymas registruoti

$_SESSION['prev']="registerS";
?>
    <html>
        <head>  
            <meta http-equiv="X-UA-Compatible" content="IE=9; text/html; charset=utf-8"> 
            <title>Registruotis kaip kursantas</title>
                    ...
                    <table class="center"><tr><td><img src="include/top.png" width="500" height="200"></td></tr><tr><td> 
                        <table style="border-width: 2px; border-style: dotted;"><tr><td>
                           Atgal į <a href="index.php">Pradžia</a></td></tr>
								...
								<div align="center">
                    			<table> <tr><td>
                                    <form action="procregisterS.php" method="POST" class="login">              
                                                <center style="font-size:18pt;"><b>Registruotis kaip kursantas</b></center>
										...
										<input class ="s1" name="amzius" type="number" min = "10" max = "85" value="<?php echo $_SESSION['amzius_login']; ?>" required><br>
										<?php echo $_SESSION['amzius_error']; ?>
										</p>
