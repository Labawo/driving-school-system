...
?>
 ...
 <?php
			if ($uregister != "admin") { 
                echo "<a href=\"register.php\">Registracija kaip destytojas</a><br>";
                echo "<a href=\"registerS.php\">Registracija kaip kursantas</a><br>";
                echo "<a href=\"registerA.php\">Registracija kaip administratorius</a>";
            }
