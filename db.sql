...
CREATE TABLE IF NOT EXISTS `naudotojai` (
  `slapyvardis` varchar(30) NOT NULL,
  `slaptazodis` varchar(32) DEFAULT NULL,
  `id` varchar(32) DEFAULT NULL,
  `lygis` tinyint(1) unsigned DEFAULT NULL,
...
INSERT INTO `naudotojai` (`slapyvardis`, `slaptazodis`, `id`, `lygis`, `el_pastas`, `timestamp`) VALUES
